                ...
                // ── Music commands ──
                 ...
                 if (command === 'reaction' || command === 'previousreact' || command === 'noselfreact') return handleReaction(message, command, args);
                     ...
                     if (command === 'event') return require('./modules/economyEvents').handleEventCommand(message, args);
                              ...
                              // ── Socials ──
                     if (SOCIALS_COMMANDS.has(command)) {
                       return handleSocialsCommand(message, command, args);
                     }
            ...
            client.on('interactionCreate', async (interaction) => {
                try {
                    ...
                    if (interaction.isChatInputCommand()) {
                        ...
                        // ── Socials slash commands ──
                        if (SOCIALS_COMMANDS.has(cmd)) {
                            ...
                            return handleSocialsCommand(interaction, cmd, args);
                        }
                    }
