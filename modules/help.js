...
const HELP_OVERRIDES = {
  ...
  levels: {
    ...
    subcommands: [
      ...
      { name: 'leaderboard rename <name>', description: 'Rename the leaderboard.' },
      { name: 'config', description: 'View level system settings.' },
      { name: 'setup', description: 'Interactive setup wizard for the leveling system.' },
      { name: 'enable', description: 'Enable XP gain.' },
      { name: 'unlock', description: 'Alias for enable.' },
      { name: 'disable', description: 'Disable XP gain.' },
      { name: 'lock', description: 'Alias for disable.' },
      ...
      { name: 'roles', description: 'View level reward roles.' },
      { name: 'list', description: 'Alias for roles.' },
      ...
      { name: 'import', description: 'Import levels from another bot format.' },
      { name: 'export', description: 'Export levels data.' },
      { name: 'blacklist add @user', description: 'Blacklist a user from gaining XP.' },
      { name: 'blacklist remove @user', description: 'Remove a user from the XP blacklist.' },
      { name: 'blacklist list', description: 'List XP blacklisted users.' },
      { name: 'cooldown <seconds>', description: 'Set the XP cooldown between messages.' },
      { name: 'minlength <chars>', description: 'Set minimum message length for XP.' },
      { name: 'maxlength <chars>', description: 'Set maximum message length for XP.' },
    ],
  },
  levelupmsg: {
    category: 'leveling',
